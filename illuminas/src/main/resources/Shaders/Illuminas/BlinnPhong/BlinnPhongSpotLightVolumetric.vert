...
const vec2 texCoordsConstants[5]=vec2[5](vec2(0, 0), vec2(1, 1), vec2(1, -1),
                                            vec2(-1, -1), vec2(-1, 1));
...
void main(){
    ...
    texCoords=texCoordsConstants[vertexId];
    ...
    worldPosition=centerPoint+mod*lightRadius*angleFactor;
